    ...
    <>
      ...
      <div className="bg-white dark:bg-gray-900 p-4 rounded-md shadow-md transition-colors duration-300">
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-blue-500 text-white font-bold px-4 py-2 mt-4 rounded-md shadow-md hover:bg-blue-600 active:bg-blue-700"
          >
            Search
          </button>
        </form>
        ...
        <div className="mt-6 space-y-3">
          {places.map(place => (
            <Fragment key={place.id}>
              ...
              <div className="border-b w-full border-gray-300 dark:border-gray-600 p-2" />
            </Fragment>
          ))}
        </div>
      </div>
